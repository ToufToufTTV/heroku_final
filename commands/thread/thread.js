module.exports = {
  ...
  async run(client, message, args) {
    ...
    if ((thread.type != 'GUILD_PUBLIC_THREAD') || (thread.type != 'GUILD_PRIVATE_THREAD')) return message.reply('Impossible de taper cette commande car vous n\'etes pas dans un thread!');
